...
class JenjangMapel extends CI_Controller {
	...
	public function edit($id)
	{
		...
		$data = [
			...
			'jenjang'	=> $this->master->getJenjang(),
			'kelas'		=> $this->master->getKelasByJenjang($mhs->jenjang_id),
			'siswa' => $mhs
		];
		$this->load->view('_templates/dashboard/_header.php', $data);
	...
	public function validasi_siswa($method)
	{
		...
		$this->form_validation->set_rules('nis', 'NIS', 'required|numeric|trim|min_length[8]|max_length[12]');
