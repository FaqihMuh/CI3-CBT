    ...
    <div class="col-sm-4">
        <div class="box box-default">
            ...
            <table class="table table-hover">
                ...
                <tr>
                    <th>Email</th>
                    <td><?=$kelasguru->email?></td>
                </tr>
                <tr>
                    <th>Telepon</th>
                    <td><?=$kelasguru->telepon?></td>
                </tr>
                <tr>
                    <th>Daftar Kelas</th>
                    <td>
                        <ol class="pl-4">
                            <?php foreach ($kelasguru2 as $k) :?>
                            <li><span class="badge bg-blue"><?= $k->nama_kelas?> - <?= $k->nama_jenjang?></span></li>
                            <?php endforeach ?>
