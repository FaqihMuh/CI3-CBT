    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <div class="form-group">
                    <label for="email">Telepon Guru</label>
                    <input value="<?=$data->telepon?>" type="number" class="form-control" name="telepon" placeholder="Telepon Guru">
                    <small class="help-block"></small>
                </div>
                <div class="form-group">
                    <label for="mapel">Mata Pelajaran</label>
                    <select name="mapel_id[]" id="mapel" class="form-control select2" style="width: 100%!important">
