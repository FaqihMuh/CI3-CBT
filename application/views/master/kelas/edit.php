                    ...
                    <tbody>
                        ...
                        foreach($kelas as $row) : ?> 
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        <select required="required" name="jenjang_id[<?=$i?>]" class="input-sm form-control select2" style="width: 100%!important">
                                            <option value="" disabled>-- Pilih --</option>
                                            <?php foreach ($jenjang as $j) : ?>
                                                <option <?= $row->jenjang_id == $j->id_jenjang ? "selected='selected'" : "" ?> value="<?=$j->id_jenjang?>"><?=$j->nama_jenjang?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <small class="help-block text-right"></small>
                                    </div>
