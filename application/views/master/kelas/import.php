<div class="box">
    ...
    <div class="box-body">
        <ul class="alert alert-info" style="padding-left: 40px">
            ...
            <li>Untuk data jenjang, hanya bisa diisi menggunakan ID Jenjang. <a data-toggle="modal" href="#jenjangId" style="text-decoration:none" class="btn btn-xs btn-primary">Lihat ID</a>.</li>
        </ul>
                            ...
                            <?php
                                ...
                                if (empty($import)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="<?= $data['jenjang'] == null ? 'bg-danger' : ''; ?>">
                                            <?= $data['jenjang'] == null ? 'BELUM DIISI' : $data['jenjang'];; ?>
                                        </td>
                                    </tr>
                            <?php
                                        if ($data['kelas'] == null || $data['jenjang'] == null) {
                                            $status = false;
                                        }
                                    endforeach;
                                }
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table id="jenjang" class="table table-condensed table-striped">
                    <thead>
                        <th>ID</th>
                        <th>Jenjang</th>
                    </thead>
