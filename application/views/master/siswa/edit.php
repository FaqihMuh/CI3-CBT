            ...
            <div class="col-sm-4 col-sm-offset-4">
                <?=form_open('siswa/save', array('id'=>'siswa'), array('method'=>'edit', 'id_siswa'=>$siswa->id_siswa))?>
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?=$siswa->telepon?>" placeholder="Telepon" type="number" name="telepon" class="form-control">
                        <small class="help-block"></small>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select id="jenjang" name="jenjang" class="form-control select2">
                            ...
                            <option <?=$siswa->id_jenjang === $j->id_jenjang ? "selected" : "" ?> value="<?=$j->id_jenjang?>">
                                <?=$j->nama_jenjang?>
                            </option>
                            <?php endforeach ?>
                        </select>
