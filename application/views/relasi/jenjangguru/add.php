            ...
            <div class="col-sm-4">
                <div class="alert bg-purple">
                    ...
                    <ol class="pl-4">
                        ...
                        <li>Guru sudah ditambahkan, jadi anda tidak perlu tambah lagi. Anda hanya perlu mengedit data Jenjang Guru nya saja.</li>
                    </ol>
                </div>
            </div>
            <div class="col-sm-4">
                <?=form_open('jenjangguru/save', array('id'=>'jenjangguru'), array('method'=>'add'))?>
...
<script src="<?=base_url()?>assets/dist/js/app/relasi/jenjangguru/add.js"></script>