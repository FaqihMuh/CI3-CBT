                        ...
                        <tbody>
                            <?php
                                ...
                                if (empty($import)) {
                                    ...
                                    <tr>
                                        <td><?= $no++; ?></td>
                                        <td class="<?= $data['nis'] == null ? 'bg-danger' : ''; ?>">
                                            <?= $data['nis'] == null ? 'BELUM DIISI' : $data['nis']; ?>
                                        </td>
                            ...
                            <?php
                                        if ($data['nis'] == null || $data['nama'] == null || $data['email'] == null || $data['jenis_kelamin'] == null || $data['kelas_id'] == null) {
                                            $status = false;
                                        }
                                    endforeach;
                                }
