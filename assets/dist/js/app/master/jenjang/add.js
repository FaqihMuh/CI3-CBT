...
$(document).ready(function () {
    ...
    $('form#jenjang input').on('change', function () {
        $(this).parent('.form-group').removeClass('has-error');
        $(this).next('.help-block').text('');
    });

    $('form#jenjang').on('submit', function (e) {
        e.preventDefault();
            ...
            <tr>
                ...
                <td>
                    <div class="form-group">
                        <input autocomplete="off" type="text" name="nama_jenjang[${i}]" class="input-sm form-control">
